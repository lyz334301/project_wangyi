function ajaxPost(t,o){return new Promise(function(e){var n=new XMLHttpRequest;n.open("POST",t),n.setRequestHeader("Content-Type","application/x-www-form-urlencoded;charset=utf-8;"),n.send(o),n.onload=function(){e(n.response)}})}
var index=0,timer=null,ban=$(".banner"),page=$(".banner ol li"),list=$(".banner ul li");$("#left");var right=$(".banner #right");function autoPlay(){++index==page.length&&(index=0),list.eq(index).fadeIn(1e3).siblings().fadeOut(1e3),page.eq(index).addClass("current").siblings().removeClass("current")}timer=setInterval(autoPlay,2e3),page.mouseenter(function(){clearInterval(timer),index=$(this).index()-1,autoPlay()}),page.mouseleave(function(){console.log(1),timer=setInterval(autoPlay,1500)}),$("#left").click(function(){clearInterval(timer),-1==--index&&(index=0,autoPlay()),list.eq(index).fadeIn(1e3).siblings().fadeOut(1e3),page.eq(index).addClass("current").siblings().removeClass("current")}),right.click(function(){clearInterval(timer),++index==page.length&&(index=-1,autoPlay()),list.eq(index).fadeIn(1e3).siblings().fadeOut(1e3),page.eq(index).addClass("current").siblings().removeClass("current")}),$(".g-row_a").mouseenter(function(){$("#grow_img1").animate({height:"325px",width:"368px"})}),$(".g-row_a").mouseleave(function(){$("#grow_img1").animate({height:"320px",width:"357px"})}),$(".g-row_b").mouseenter(function(){$("#grow_img2").animate({width:"368px",height:"325px"})}),$(".g-row_b").mouseleave(function(){$("#grow_img2").animate({height:"320px",width:"357px"})}),$(".g-row_c_t").mouseenter(function(){$("#grow_img3").animate({height:" 160px",width:"368px"})}),$(".g-row_c_t").mouseleave(function(){$("#grow_img3").animate({width:"357px",height:"155px"})}),$(".g-row_c_b").mouseenter(function(){$("#grow_img4").animate({height:" 160px",width:"368px"})}),$(".g-row_c_b").mouseleave(function(){$("#grow_img4").animate({width:"357px",height:"155px"})});
function setCookie(e,o,t){var i=new Date;i.setTime(i.getTime()+24*t*60*60*1e3),document.cookie=e+"="+o+";expires="+i}function getCookie(e){if(document.cookie){for(var o=document.cookie.replace(/;\s/g,";").split(";"),t=0;t<o.length;t++)if(item=o[t].split("="),item[0]==e)return brr=item[1],JSON.parse(brr);return[]}return[]}function removeCookie(e){setCookie(e,"",-1)}
var fimg=$(".m-ul ul"),fpage=$(".m-ul ul li"),Oleft=$("#aleft"),Oright=$("#aright"),findex=0,ft=null;function Auto(){7==++findex&&(findex=0,$(".m-ul ul").css("left","0")),$(".m-ul ul").animate({left:365*-findex})}ft=setInterval(Auto,1500),Oleft.click(function(){findex--,clearInterval(ft),-1==findex&&(findex=6,$(".m-ul ul").css({left:365*-findex})),$(".m-ul ul").animate({left:365*-findex}),ft=setInterval(Auto,1500)}),Oright.click(function(){findex++,clearInterval(ft),6==findex&&(findex=0,$(".m-ul ul").css({left:365*-findex})),$(".m-ul ul").animate({left:365*-findex}),ft=setInterval(Auto,1500)});
function getAjax(e,t,n){var s=null;n&&(e+=n),(s=window.XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.HTTP")).open("get",e,!0),s.send(),s.onreadystatechange=function(){4==s.readyState&&200==s.status&&(res=s.responseText,t(res))}}function promiseAjax(s,o){return new Promise(function(t,e){o&&(s=s+"?"+o);var n=new XMLHttpRequest;n.open("get",s,!0),n.send(),n.onreadystatechange=function(){if(4==n.readyState&&200==n.status){var e=n.responseText;t(e)}},setTimeout(function(){e("失败")},5e3)})}
$(function(){var o=0,s=null;!function(){clearInterval(s);var e=$("#scroll ul"),n=e.children("li"),t=n.height();e.css("height",t*n.length*2),s=setInterval(function(){o>=n.length?(e.css({top:0}),o=1):o++,e.animate({top:-o*t},800)},1500)}(),$(".qiye").mouseover(function(){$(".erji").css("display","block")}),$(".qiye").mouseout(function(){$(".erji").css("display","none")}),$(".kehu").mouseover(function(){$(".erji1").css("display","block")}),$(".kehu").mouseout(function(){$(".erji1").css("display","none")}),$(".App").mouseover(function(){$(".img").css("display","block")}),$(".App").mouseout(function(){$(".img").css("display","none")}),$("#txt").mouseover(function(){$(".toefl").css("display","block")}),$(".toefl").mouseover(function(){$(".toefl").css("display","block")}),$(".toefl").mouseout(function(){$(".toefl").css("display","none")}),$("#txt").blur(function(){$("#u").css("display","none")}),$(".toefl").click(function(e){var n=(e=e||event).target||e.srcElement;"LI"==n.nodeName&&($("#txt").val(n.innerHTML),$(".toefl").css("display","none"))}),$(".toefl").mouseover(function(e){var n=(e=e||event).target||e.srcElement;"LI"==n.nodeName&&(n.style.background="rgb(181, 179, 189)")}),$(".toefl").mouseout(function(e){var n=(e=e||event).target||e.srcElement;"LI"==n.nodeName&&(n.style.background="")}),$(".aaaa1").mouseover(function(){$(".jujia").css("display","block")}),$(".aaaa1").mouseout(function(){$(".jujia").css("display","none")}),$(".ceiling_nav_li").mouseover(function(){$(".ceiling_nav_s").css("display","block")}),$(".ceiling_nav_li").mouseout(function(){$(".ceiling_nav_s").css("display","none")})}),window.onload=function(){var t=document.getElementById("txt"),i=document.getElementById("u"),e=document.querySelector(".toefl");t.onkeyup=function(){if(""==t.innerHTML&&(i.style.display="none"),i.style.display="block",e.style.display="none",(i.innerHTML="")!=this.value){var l=this.value;getAjax("data.json",function(e){for(var n=JSON.parse(e),t=0;t<n.length;t++){var o=n[t],s=document.createElement("li");s.innerHTML=o.pname,-1!=s.innerHTML.indexOf(l)&&i.appendChild(s)}})}else i.innerHTML=""},i.onmouseover=function(e){i.style.display="block";var n=(e=e||event).target||e.srcElement;"LI"==n.nodeName&&(n.style.background="rgb(181, 179, 189)")},i.onmouseout=function(e){i.style.display="none";var n=(e=e||event).target||e.srcElement;"LI"==n.nodeName&&(n.style.background="")},i.onclick=function(e){console.log(1);var n=(e=e||event).target||e.srcElement;"LI"==n.nodeName&&(t.value=n.innerHTML,i.style.display="none")};var n=document.getElementById("S_left"),o=document.getElementById("S_right"),s=document.querySelector(".lunbo_img"),l=0;$(n).click(function(){-1==--l&&(l=0,$(s).css("left","0")),$(s).animate({left:1090*-l})}),$(o).click(function(){3==++l&&(l=2,$(s).css("left"," -2 * 1090")),$(s).animate({left:1090*-l})});for(var c=document.getElementById("m-Item_bt").getElementsByTagName("a"),a=(i=document.getElementsByClassName("m-main"),0);a<c.length;a++)c[a].myindex=a,c[a].onclick=function(){for(var e=0;e<c.length;e++)c[e].className="",i[e].style.display="none";this.className="on",i[this.myindex].style.display="block"};var u=new Date("2019/1/1"),r=document.getElementById("hour"),m=document.getElementById("minute"),d=document.getElementById("second");function f(){var e=new Date,n=u.getTime()-e.getTime(),t=parseInt(n/1e3/60/60),o=parseInt((n-1e3*t*3600)/1e3/60),s=parseInt((n-1e3*t*3600-1e3*o*60)/1e3);t<10&&(t="0"+t),o<10&&(o="0"+o),s<10&&(s="0"+s),r.innerHTML=t,m.innerHTML=o,d.innerHTML=s}f(),setInterval(function(){f()},1e3)},txt.focus=function(){""==txt.value&&(con.style.border="0")},window.onscroll=function(){300<(document.body.scrollTop||document.documentElement.scrollTop)?$(".xiding").css({position:"fixed",top:"0"}).slideDown():$(".xiding").css({position:"static",display:"none"})};
...
function $id(t){return document.getElementById(t)}function rand(t,e){return Math.round(Math.random()*(e-t)+t)}function getColor(){for(var t="#",e=0;e<=5;e++)t+="0123456789ABCDEF".charAt(rand(0,15));return t}function zero(t){return t<10?"0"+t:t}function diff(t,e){return Math.abs(t.getTime()-e.getTime())/1e3}function pz(t,e){var f=t.offsetLeft,o=t.offsetWidth+t.offsetLeft,n=t.offsetTop,r=t.offsetHeight+t.offsetTop,u=e.offsetLeft,i=e.offsetWidth+e.offsetLeft,s=e.offsetTop,a=e.offsetHeight+e.offsetTop;return!(o<u||i<f||r<s||a<n)}function addres(t){var e={};return t.replace(/([^?=&]+)=([^?=&]+)/g,function(){e[arguments[1]]=arguments[2]}),e}
var myindex=0,page2=$(".sec-img ul li"),list2=$(".sec-img p span"),oLeft1=$("#sec-left"),oRight1=$("#sec-right");oRight1.click(function(){3==++myindex&&(myindex=0),page2.eq(myindex).fadeIn().siblings().fadeOut(),list2.eq(myindex).addClass("scr-y").siblings().removeClass("scr-y")}),oLeft1.click(function(){-1==--myindex&&(myindex=2),page2.eq(myindex).fadeIn().siblings().fadeOut(),list2.eq(myindex).addClass("scr-y").siblings().removeClass("scr-y")});
var t=null,Myindex=0,main=$(".f-grow-img"),oLeft=$("#f-grow-left"),oRight=$("#f-grow-right"),con=$(".f-grow-img ul li"),yuan=$(".f-grow-img p span");function auto(){++Myindex==yuan.length&&(Myindex=0),con.eq(Myindex).fadeIn(1500).siblings().fadeOut(1500),yuan.eq(Myindex).addClass("mpf").siblings().removeClass("mpf")}t=setInterval(auto,2e3),yuan.mouseenter(function(){clearInterval(t),Myindex=$(this).index()-1,auto()}),yuan.mouseleave(function(){auto()}),main.mouseenter(function(){clearInterval(t),$("#f-grow-right").css("display","block"),$("#f-grow-left").css("display","block")}),main.mouseleave(function(){$("#f-grow-right").css("display","none"),$("#f-grow-left").css("display","none"),t=setInterval(auto,1500)}),oLeft.click(function(){clearInterval(t),-2==--Myindex&&(Myindex=0,auto()),con.eq(Myindex).fadeIn().siblings().fadeOut(),yuan.eq(Myindex).addClass("mpf").siblings().removeClass("mpf")}),oRight.click(function(){clearInterval(t),3==++Myindex&&(Myindex=2,auto()),con.eq(Myindex).fadeIn().siblings().fadeOut(),yuan.eq(Myindex).addClass("mpf").siblings().removeClass("mpf")});